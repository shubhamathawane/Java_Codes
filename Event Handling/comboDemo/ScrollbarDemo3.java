...
/*
<applet code = ScrollbarDemo3 width = "900" height = "500">
</applet>
*/

public class ScrollbarDemo3 extends Applet implements AdjustmentListener,ActionListener
{
	Scrollbar s1,s2,s3;
	...
	public void start()//Graphics g)
	{
		...
		lb2 = new Label("Select GREEB ratio");
